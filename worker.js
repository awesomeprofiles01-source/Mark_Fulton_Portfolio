...
LinkedIn: linkedin.com/in/mark-fulton-opstrainer
...
Locations: Kidal, Timbuktu, Bamako, Gao
...
- Reduced budget waste by 20%
- Reduced team response times by 25%
- Zero incidents in complex security environment

Timbuktu (2017 - September 2019):
- Designed and built two high-capacity bunkers for personnel and Explosive Detection Dogs
- Coordinated logistics for four major projects
- Recruited, trained and supervised local staff
- All projects delivered on schedule and within budget, no equipment losses or safety incidents

Bamako, Kidal, Gao, Timbuktu (December 2016 - 2017):
- Oversaw logistics across multiple locations with team of 35 local buyers, drivers and assistants
- Managed fleet operations, resource procurement and administrative functions
...
- Developed and implemented logistics systems improving supply chain efficiency
- Managed fleet operations and procurement
...
- Streamlined fleet management, improving availability and reducing downtime
...
- Microsoft Excel & MS Access Systems
...
- CBIR Analytics (Cognitive-Behavioural Insights)
- Organisation dashboard for team training management
      ...
      try {
        ...
        const response = await fetch("https://api.anthropic.com/v1/messages", {
          ...
          body: JSON.stringify({
            ...
            max_tokens: 500,
            system: `You are a professional assistant representing Mark Fulton. Answer questions exclusively based on his CV and background provided below. Be concise, professional and helpful. If asked something not covered in the CV, politely say you can only answer questions about Mark's professional background.\n\n${CV_CONTEXT}`,
